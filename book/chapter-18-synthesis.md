...
2. **Particle-spectrum closure**: keep the closed electroweak theorem synchronized across public surfaces, close the CKM/CP and overlap-law fronts behind the current quark rows, close the charged-lepton and flavor-neutrino bridges, and replace the hadron surrogate bridge with real production execution plus systematics.
