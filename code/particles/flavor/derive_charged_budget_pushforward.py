...
DEFAULT_OUT = ROOT /  "runs" / "flavor" / "charged_budget_transport.json"
...
def build_artifact(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "charged_dirac_scalarization_certificate": {
            ...
            "mean_side_support_status": "tightest_remaining_clause",
            ...
            "strict_next_clause": "charged_common_refinement_mean_eigenvalue_certificate",
            "mean_clause": {
                "left_common": None,
                "right_common": None,
                "residual": None,
            ...
            "transported_ordered_spectral_package_evidence_status": "serialization_only_not_independent_witness",
            ...
            "minimal_missing_witness": None if functional_equalizer_closed else ("charged_common_refinement_mean_eigenvalue_certificate" if common_refinement_only_missing else "sector_projected_sigma_seed_equalizer"),
        ...
        "metadata": {
            ...
            "note": "Shared charged-sector budget artifact. The current constructive candidate is the charged_common_refinement_sigma_seed_equalizer: the monoidal completion of the common family spectral seed sigma_seed = mean(family_eigenvalues) + min(spectral_gaps) on the canonical decomposable charged direct-sum family. The generatorwise descent has now reduced the remaining base theorem burden to ordered common-refinement seed rigidity, with the strict next constructive witness being charged_common_refinement_mean_eigenvalue_certificate while the min-gap side is already proxy-supported on the current family. The left/right spectral packages remain explicitly marked as serialization-only rather than independent evidence.",
        },
    }
