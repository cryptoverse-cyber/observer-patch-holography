...
FAMILY_SCRIPT = ROOT /  "calibration" / "derive_d10_ew_observable_family.py"
SCRIPT = ROOT /  "calibration" / "derive_d10_ew_transport_kernel.py"
OUTPUT = ROOT /  "runs" / "calibration" / "d10_ew_transport_kernel.json"
