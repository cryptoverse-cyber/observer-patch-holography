...
PARTICLE_CODE_DIR = REPO_ROOT / "core"
...
def build_audit(
    *,
    ...
    return {
        ...
        "source_branch": "code/particles/core/particle_masses_paper_d10_d11.py",
        "p_default": p_center,
        "p_scan_min": p_min,
        "p_scan_max": p_max,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=REPO_ROOT /  "runs" / "calibration" / "implied_p_consistency.json",
    )
