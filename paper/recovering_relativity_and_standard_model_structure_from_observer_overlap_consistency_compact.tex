...
\bottomrule
\endfoot
\textbf{D1} & Unique schedule-independent normal form for the declared recovery-derived repair relation (Theorem~\ref{thm:confluence}) & overlap-consistency problem on a finite patch net together with the declared fixed-cutoff collar recovery step & finite-valued Lyapunov descent on the inconsistency potential plus Newman's lemma for locally confluent terminating repair relations & finite state spaces, repair completeness, strict \(\Phi\)-descent, and local confluence on the declared recovery branch; stated Petz support/CPTP control where that branch is used & Phase I structural theorem \\
...
\bottomrule
\endfoot
\textbf{D1} & Theorem~\ref{thm:confluence}: unique normal form and schedule independence for the declared recovery-derived repair relation & overlap-consistency problem on a finite patch net together with the declared fixed-cutoff collar recovery step & finite-valued Lyapunov descent on the inconsistency potential plus Newman's lemma for locally confluent terminating repair relations & finite state spaces, repair completeness, strict \(\Phi\)-descent, and local confluence on the declared recovery branch; stated Petz support/CPTP control where that branch is used & structural theorem \\
...
\begin{proof}
Because \(\Sigma\) is finite and every enabled repair strictly decreases \(\Phi\), the
inconsistency potential is a Lyapunov functional and no infinite repair sequence exists. Thus the
repair relation is terminating. Local confluence plus termination imply confluence by Newman's
lemma~\cite{newman42}. The resulting normal form is unique. By assumption it is a globally
consistent state.
\end{proof}
...
completeness together with the Lyapunov \(\Phi\)-descent and local-confluence hypotheses on the
declared branch, and the Petz support/CPTP clause where that branch is used.
