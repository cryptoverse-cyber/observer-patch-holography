...
\item The compact note presents the main theorem statements in one place, but some quantitative conventions and implementation details live in repository supplements.\footnote{Questions about ultimate purpose are deferred until the corresponding physical question has been posed with enough precision to deserve an answer.} For length, several theorem-level arguments below are recorded only as proof sketches; the synchronized main paper is the full-proof surface for those derivations.
