...
Lorentz kinematics & $\Conf^+(S^2)\cong\mathrm{SO}^+(3,1)$ in the geometric modular phase & conditional classification theorem & scaling-limit theorem & Geometric modular flow on caps in the assumed geometric phase \\
Einstein dynamics & Jacobson-type first-variation relation with tensor upgrade & conditional theorem + corollary & conditional scaling-limit theorem & Fixed-cap generalized-entropy stationarity, d=4 small-ball bridge, and null modular / null-stress premises \\
...
Charge lattice & Exact Standard Model hypercharges on the realized matter package & theorem & structural theorem on the realized branch & Anomaly cancellation and Yukawa invariance \\
Discrete matter content & $N_c=3$, $N_g=3$ on the realized MAR-admissible branch & corollary chain & structural theorem & CKM CP capability, anomaly constraints, admissibility, and MAR \\
Parameter economy & Two external continuous configuration inputs in the current quantitative implementation & implementation fact & current quantitative implementation & Pixel area and screen capacity only at the present numerical level \\
Unification sector & MSSM-like coupling evolution without light superpartners & supplement-backed numerical reduction & calibration sector & Edge-sector beta-function shifts and supplement-backed matching conventions \\
Electroweak scale & $v$, $m_W$, gauge couplings & supplement-backed numerical reduction & calibration sector & Pixel constraint and self-consistent fixed point \\
Higgs and top & $m_H \approx 126.5$ GeV, $m_t \approx 171.1$ GeV & supplement-backed numerical branch & independent quantitative & Critical surface $\lambda=\beta_\lambda=0$ at $M_U$ plus supplement-backed transport \\
...
Edge-sector fingerprints & conditional $\mathbb Z_6$ center-label entropy and exact $\SU(3)$ Casimir ratios & program corollary & program-level phenomenology & Quotient-label ansatz and heat-kernel spectrum \\
...
Einstein equation & conditional scaling-limit theorem & admissible first variations, fixed-cap generalized-entropy stationarity, exact-or-controlled null-strip Markov premise, half-sided modular inclusion premise or its scaling-limit blow-up corollary, localized generalized entropy, d=4 small-ball first law, scaling-limit null-stress identification, null-to-tensor upgrade \\
...
Two-input quantitative implementation & implementation fact & no extra ingredients, but the continuous inputs are external in the current quantitative implementation \\
Gauge and electroweak closure in one-input mode & supplement-backed calibration sector & pixel constraint, edge heat-kernel closure, and supplement-backed beta-function / matching conventions \\
Higgs/top branch and flavor continuations & mixed quantitative / phenomenological & critical-surface boundary condition for Higgs/top with supplement-backed transport; discrete holonomy data and a $\mathbb Z_6$-motivated ansatz for the flavor continuation \\
