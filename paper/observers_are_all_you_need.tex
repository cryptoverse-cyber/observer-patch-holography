...
the consensus/fixed-point formulation, the quotient-level UV uniqueness statement, the
...
on the gauge quotient once the declared recovery-derived repair moves are committed by the
...
quotient, and repair completeness holds on the stated finite patch-net branch.
