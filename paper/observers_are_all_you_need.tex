...
and hadron lanes carry named remaining closure objects; at the local numerical level the same
calibrated input \(P\) already organizes the bosonic mass trunk and the gravity-side bridge
candidate.
