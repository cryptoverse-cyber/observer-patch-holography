...
on the gauge quotient once the declared recovery-derived repair moves are repair-complete and
locally confluent on the stated finite patch-net branch; on that branch the touched-overlap
local-fit contract yields Lyapunov descent of the inconsistency potential \(\Phi\).
