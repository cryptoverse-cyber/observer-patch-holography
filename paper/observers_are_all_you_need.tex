...
neutrino lane closes on its weighted-cycle theorem branch with diagnostic sidecars below it, the
quark lane closes on the public physical quark frame class selected by \(P\) without claiming a global classification of all quark frame classes, and the
hadron lane remains an execution-contract surface rather than a mass-derivation theorem lane;
at the local numerical level the same declared input \(P\) organizes the bosonic mass
