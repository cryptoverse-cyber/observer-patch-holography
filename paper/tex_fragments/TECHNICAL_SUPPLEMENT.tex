...
Sections 9--13 record continuation benchmarks and heuristic downstream branches, not theorem-level supplement outputs. Their status is the Phase-III / deferred-continuation tier summarized in Appendix~A.2 unless and until a later authority update promotes a specific branch.
