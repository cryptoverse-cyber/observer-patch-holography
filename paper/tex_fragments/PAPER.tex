...
\textbf{D5} & Theorem 5.1: Einstein branch & D3+D4 & Jacobson small-ball mathematics; null-to-tensor reconstruction modulo a metric term & the derived fixed-cap generalized-entropy stationarity theorem for admissible fixed-cap MaxEnt variations on the realized cap-label-preserving MaxEnt family, together with the locally Lorentzian \(d=4\) scaling regime, the separate interval-preserving projective branch used to transport the D4 half-line identification to bounded intervals, small-ball constancy assumptions, D4 carried remainder negligible at order \(\ell^4\), and the all-directions/all-reference-states premise used in the tensor upgrade & conditional scaling-limit theorem \\
...
\textbf{D5} & Theorem 5.1 rest-frame Einstein relation plus the conditional tensor upgrade of Corollary 5.1 & Jacobson small-ball mathematics; null-to-tensor reconstruction modulo a metric term & the derived fixed-cap generalized-entropy stationarity theorem for admissible fixed-cap MaxEnt variations on the realized cap-label-preserving MaxEnt family, the locally Lorentzian \(d=4\) scaling regime, the separate interval-preserving projective branch used in the small-ball step, small-ball constancy assumptions, D4 carried remainder negligible at order \(\ell^4\), and the all-directions/all-reference-states premise used in the tensor upgrade & Phase I conditional scaling-limit theorem/corollary \\
...
\emph{Resolution:} The framework combines the MaxEnt-selected fixed-cap generalized-entropy stationarity theorem, the derived K\_C = 2\ensuremath{\pi}B\_C structure with rigid normalization, and an EFT bridge identifying modular energy with stress-tensor charges. The null modular additivity route reduces much of that bridge to Markov/edge-center mechanisms on null strips plus explicit scaling-limit regularity premises. It does not rely only on "assume a UV CFT."
