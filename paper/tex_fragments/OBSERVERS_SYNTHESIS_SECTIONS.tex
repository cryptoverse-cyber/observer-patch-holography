...
Electroweak bosons & calibration branch & \(W\) and \(Z\) values on the electroweak calibration surface & repair/value law beyond the present electroweak carrier \\
...
Quark family & continuation branch & transport and family structure; emitted quark rows remain continuation-level & selector/value law, CKM generator, and CP closure \\
Charged leptons and neutrinos & continuation branch & family-level overlap and eta-class structure & theorem-grade emission of the remaining source and basis data \\
