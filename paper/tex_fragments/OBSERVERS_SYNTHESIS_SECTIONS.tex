...
On a finite patch net with local recovery-derived repair maps, if the repair relation is complete
for global consistency, accepted moves are committed by the local-fit contract on every touched
overlap set, and the repair relation is locally confluent, then every initial configuration has a
...
and rules out infinite repair sequences. Newman's
