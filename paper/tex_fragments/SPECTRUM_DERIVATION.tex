...
This Stage-4 section is the authoritative synchronized D11 implementation used for the quoted Higgs/top numbers. The compact appendix records the same core one-loop RG equations, but the numerical outputs below also use the matching, low-scale extraction, and pole-mass conventions fixed here in the synchronized supplement-backed branch.
